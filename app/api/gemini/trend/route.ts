...
export async function POST() {
  const r = await genJSON<any>(`${TREND_SYSTEM}\n\nTrends 2024-2025: AI tools for students rising rapidly, prompt engineering +700%, coding +85%, video editing +90%, public speaking online -30%, data analysis +100%, 3D modeling +75%.`);
