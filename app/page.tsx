    ...
    <div>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16" data-reveal>
        <div className="absolute inset-0 z-0">
          <Image src="/images/hero-main.png" alt="" fill className="object-cover opacity-30" priority />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center">
          <div data-reveal className="inline-flex items-center gap-2 glass px-4 py-1.5 rounded-full text-xs label mb-8">
            ...
            <span className="text-text-muted">{stats.total} responses analyzed</span>
          </div>
          <h1 className="font-display font-black leading-[0.85] tracking-tight" data-split>
            SCREENS become SKILLS.
          </h1>
          <p className="mt-8 text-text-secondary text-lg sm:text-xl max-w-2xl mx-auto text-balance" data-reveal>
            We surveyed <LiveCounter initial={stats.total} /> real students. We analyzed their digital habits with AI. We built this.
          </p>
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center" data-reveal>
            <Link href="/dashboard" className="btn-primary text-base group">
              EXPLORE DASHBOARD
          ...
          <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-3 max-w-4xl mx-auto" data-reveal>
            <KPI value={stats.total} label="Students" icon="Users" />
      ...
      <Marquee items={[
        ...
        "145+ students", "12+ cities", "Screen2Skill 2026", "WAKE UP TO REALITY"
      ]} />
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-24 sm:py-32 max-w-7xl mx-auto" data-reveal>
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-6 md:col-start-7 space-y-6 text-text-secondary leading-relaxed">
            ...
            <p>SkillVerse uses AI to analyze 145+ real survey responses from teenagers across India, mapping exactly how digital platforms translate into actual skills—from coding to communication to AI prompting.</p>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-24 sm:py-32 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div data-reveal>
            ...
            <p className="text-text-secondary text-lg mb-8">Every AI feature uses Google Gemini 2.0 Flash with OpenRouter fallback. Real analysis on real data.</p>
